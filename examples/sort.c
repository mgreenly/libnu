...
static int compare_by_salary_desc(const void* a, const void* b) {
    const Person* p1 = (const Person*)a;
    const Person* p2 = (const Person*)b;
...
static int compare_by_full_name(const void* a, const void* b) {
    const Person* p1 = (const Person*)a;
    const Person* p2 = (const Person*)b;
...
static int compare_by_age_group_and_name(const void* a, const void* b) {
    const Person* p1 = (const Person*)a;
    const Person* p2 = (const Person*)b;
 ...
 */
static void print_people(const char* title, Person people[], size_t count) {
    printf("\n%s:\n", title);
