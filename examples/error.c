...
static nu_result_t parse_int(const char* str, int* out) {
...
static nu_result_t parse_config_line(const char* line, char* key, char* value) {
...
static nu_result_t parse_server_config(const char* config_text, ServerConfig* config) {
...
static void print_config(const ServerConfig* cfg) {
